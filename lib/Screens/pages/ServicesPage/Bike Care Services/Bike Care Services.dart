...
class BikeCareServices extends StatefulWidget {
  final String? title;
  BikeCareServices({@required this.title});

  @override
  _BikeCareServicesState createState() => _BikeCareServicesState();
}

class _BikeCareServicesState extends State<BikeCareServices> {
  ///
